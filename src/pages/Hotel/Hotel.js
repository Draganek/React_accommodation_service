    ...
    return loading ? <LoadingIcon /> : (
        <div className="card">
            ...
            <div className="card-body">
                <img src={`https://www.salebiznesowe.pl/media/objects/object3514/object/ob.jpg`}
            ...
            <div className="card-footer">
                {auth ? (
                    <div className="form-group row mt-4">
                        <div className="col">
                            <select value={rating} onChange={e => setRating(e.target.value)} className="form-control form-select-lg mb-3">
